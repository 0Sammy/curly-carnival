const Chart = () => {
    return (
        <main className="flex flex-col gap-y-2 bg-white p-2 text-deepBlack">
            <section className="gap-2 grid grid-cols-2">
                <div className="flex flex-col items-center p-2 border border-primaryGreen rounded-lg text-center">
            ...
            <section className="grid grid-cols-4">
                <div className="flex flex-col items-center p-2 border border-primaryGreen rounded-tl-lg">
                ...
                <div className="flex flex-col items-center p-2 border-primaryGreen border-y border-r">
                ...
                <div className="flex flex-col items-center p-2 border-primaryGreen border-y">
                ...
                <div className="flex flex-col items-center p-2 border border-primaryGreen rounded-tr-lg">
            ...
            <section className="flex -mt-2 border-primaryGreen border-b rounded-bl-lg rounded-br-lg">
                <div className="flex flex-col gap-y-3 p-3 border-primaryGreen border-x w-[35%]">
                ...
                <div className="flex flex-col gap-y-3 p-3 border-primaryGreen border-r w-[65%]">
